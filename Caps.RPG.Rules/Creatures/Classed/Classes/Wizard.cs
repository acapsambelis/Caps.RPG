...
namespace Caps.RPG.Rules.Creatures.Classed.Classes
{
    public class Wizard : CharacterClass
    {
        ...
        {
            { 1, new CombatAction("Firebolt", "You deal damage to one target equal to 5 times your Wizard level.", 1, Firebolt, new ActionSetup(true, 10, ActionSetup.SourceType.SingleCreature)) },
            { 1, new CombatAction("Fireball", "You deal damage in a radius equal to 5 times your Wizard level.", 1, Fireball, new ActionSetup(true, 10, ActionSetup.SourceType.SingleCreature)) },
        };
