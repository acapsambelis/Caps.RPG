...
namespace Caps.RPG.Rules.Creatures.Classed.Classes
{
    public class Rogue : CharacterClass
    {
        ...
        {
            { 1, new CombatAction("Sneak Attack", "You deal damage to one target equal to 5 times your Rogue level.", 1, SneakAttack, new ActionSetup(true, 5, null, ActionSetup.TargetType.SingleCreature)) },
        };
