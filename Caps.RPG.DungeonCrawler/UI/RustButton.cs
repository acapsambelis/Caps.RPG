...
namespace Caps.RPG.DungeonCrawler.UI
{
    public class RustButton : Button
    {
        ...
        public RustButton(TextureAtlas atlas, string text, string fontFntFile)
        {
            ...
            TextureRegion unfocusedTextureRegion = atlas.GetRegion("unfocused-button-rust");
            ...
            TextureRegion focusedTextureRegion = atlas.GetRegion("focused-button-rust");
