...
The most common anchors are 'Auto' and 'AutoInline', which will place entities one after another automatically.",
                ...
                // example: animators
                {
                    ...
                    // float up-down
                    {
                        ...
                        entity.AttachAnimator(new GeonBit.UI.Animators.FloatUpDownAnimator());
                    }
                    ...
                    // wave animation
                    {
                        ...
                        entity.AttachAnimator(new GeonBit.UI.Animators.TextWaveAnimator());
                    }
                    ...
                    // fade out
                    {
                        ...
                        var animator = entity.AttachAnimator(new GeonBit.UI.Animators.FadeOutAnimator() { Enabled = false });
                        entity.OnClick += (ent) =>
                        {
                    ...
                    // type writer animator
                    {
                        ...
                        var animator = entity.AttachAnimator(new GeonBit.UI.Animators.TypeWriterAnimator()
                        {
...
Maybe something interesting in tab3?"));
                    ...
                    panel.AddChild(new Paragraph("Or you can create custom message and buttons:"));
                    {
                        ...
                        btn.OnClick += (Entity entity) =>
                        {
                            GeonBit.UI.Utils.MessageBox.ShowMsgBox("Custom Message!", "In this message there are two custom buttons.\n\nYou can set different actions per button. For example, click on 'Surprise' and see what happens!", new GeonBit.UI.Utils.MessageBox.MsgBoxOption[] {
                                ...
                                new GeonBit.UI.Utils.MessageBox.MsgBoxOption("Surprise", () => { GeonBit.UI.Utils.MessageBox.ShowMsgBox("Files Removed Successfully", "Win32 was successfully removed from this computer. Please restart to complete OS destruction."); return true; })
                                });
                        };
                        panel.AddChild(btn);
                    }
                ...
                // example: forms
                {
                    ...
                    btn.OnClick += (ent) =>
                    {
                        ...
                        GeonBit.UI.Utils.MessageBox.ShowMsgBox("Example Form", "", "Close Form And Show Values", extraEntities: new Entity[] { newForm.FormPanel }, onDone: () =>
                        {
                            GeonBit.UI.Utils.MessageBox.ShowMsgBox("Form Values", string.Format(
                                "Text Field: '{5}{0}{6}'\r\n" +
                                "Slider: '{5}{1}{6}'\r\n" +
                                "Radio Buttons: '{5}{2}{6}'\r\n" +
                                "Checkbox: '{5}{3}{6}'\r\n" +
                ...
                // example: file dialog
                {
                    ...
                    // add save file button
                    {
                        ...
                        btn.OnClick += (ent) =>
                        {
                            GeonBit.UI.Utils.MessageBox.OpenSaveFileDialog("", (GeonBit.UI.Utils.FileDialogResponse res) =>
                            {
                    ...
                    // add load file button
                    {
                        ...
                        btn.OnClick += (ent) =>
                        {
                            GeonBit.UI.Utils.MessageBox.OpenLoadFileDialog("", (GeonBit.UI.Utils.FileDialogResponse res) =>
                            {
                ...
                // example: top menu
                {
                    ...
                    var layout = new GeonBit.UI.Utils.MenuBar.MenuLayout();
                    ...
                    layout.AddItemToMenu("Interactive", "Click Me", (GeonBit.UI.Utils.MenuBar.MenuCallbackContext context) =>
                    {
                        context.Entity.ChangeItem(context.ItemIndex, "I was clicked!");
                    });
                    layout.AddItemToMenu("Interactive", "Toggle Me", (GeonBit.UI.Utils.MenuBar.MenuCallbackContext context) =>
                    {
                    ...
                    var menuBar = GeonBit.UI.Utils.MenuBar.Create(layout);
                    ...
                    menuBar = GeonBit.UI.Utils.MenuBar.Create(layout, PanelSkin.Fancy);
                    menuBar.Anchor = Anchor.Auto;
                    panel.AddChild(menuBar);
                }
...
Click on 'Next' to see the character creation demo."));
                ...
                // example: character build page - final
                {
                    ...
                    // create grid
                    var columnPanels = GeonBit.UI.Utils.PanelsGrid.GenerateColums(3, entitiesGroup);
